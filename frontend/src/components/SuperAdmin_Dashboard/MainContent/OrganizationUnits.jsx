...
const OrganizationUnits = () => {
  ...
  return (
    <div>
      <div className="m-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <nav>
          <ol className="flex items-center gap-2">
            ...
            <li className="font-medium text-primary">Department Management</li>
          </ol>
        </nav>
      </div>
      <div className="flex flex-col">
        <div className="overflow-x-auto">
          <div className="min-w-full inline-block align-middle">
            <div className="relative  text-gray-500 focus-within:text-gray-900 mb-4 flex w-full justify-between">
              <div>
              ...
              <Plus
                className="btn mr-4 bg-[#1c2434] text-white rounded-full px-2 w-10 h-4"
                onClick={() => {
                  document.getElementById("m_addDepartment").showModal();
                  setTextHeader("Add Department");
                  setEdit(false);
                }}
              />
            </div>
                    ...
                    >
                      ...
                      <td className=" p-5 ">
                        <div className="flex items-center gap-1">
                          {/* Edit Button */}
                          <button
                            className="p-2  rounded-full  group transition-all duration-500  flex item-center hover:bg-indigo-100"
                            onClick={() => {
                              document
                                .getElementById("m_addDepartment")
                                .showModal();
                              setSelectedUser(item);
                              setTextHeader("Edit Department");
                              setEdit(true);
                            }}
                          >
                            <svg
                          ...
                          <button
                            ...
                            onClick={() => {
                              document
                                .getElementById("m_viewDepartment")
                                .showModal();
                              setSelectedUser(item);
                              setTextHeader("Department Information");
                            }}
                          >
                            <svg
                              width="20"
      ...
      {/*  */}
      <Department
        modalId={"m_addDepartment"}
        headText={textHeader}
        onEditChange={edit}
      />
      <ViewDepartment modalId={"m_viewDepartment"} headText={textHeader} />
